...
require_once 'Yeahcheese_Error.php';
require_once 'Yeahcheese_ActionClass.php';
 ...
 *  @package    Yeahcheese
 */
class Yeahcheese_Controller extends Ethna_Controller
{
    /**#@+
     *  @access protected
     */
    ...
    protected $forward = array(
         ...
         *
         *  'index'         => array(
         *      'view_name' => 'Yeahcheese_View_Index',
         *  ),
         */
    );
    ...
    public $class = array(
        ...
        'view'          => 'Yeahcheese_ViewClass',
        'renderer'      => 'Ethna_Renderer_Smarty',
        'url_handler'   => 'Yeahcheese_UrlHandler',
    );
